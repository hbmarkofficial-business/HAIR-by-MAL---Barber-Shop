  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | HAİR by MALİ Barber Shop</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop HAİR by MALİ Barber Shop in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="HAİR by MALİ Barber Shop | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="HAİR by MALİ Barber Shop | Premium Barbershop Berlin" />
        <meta
